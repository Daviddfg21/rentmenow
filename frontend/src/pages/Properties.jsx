...
import { Search, Filter, MapPin, Euro, Bed, Bath, Grid, List } from 'lucide-react'
            ...
            {filteredProperties.map((property, index) => (
              ...
              >
                {viewMode === 'grid' ? (
                  ...
                  <div className="card p-6 flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6">
                    <div className="md:w-1/3">
                      <div className="h-48 bg-gradient-to-br from-primary-400 to-secondary-400 rounded-xl flex items-center justify-center relative">
                    ...
                    <div className="md:w-2/3 space-y-3">
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                        <div className="text-sm text-gray-500">
                          Propietario: {property.ownerUsername}
                        </div>
